    ...
    if len(leastCourse) > 0 :        
        ...
        for j in leastCourse :
            if Course[j].NoStuds < Course[Coursedel].NoStuds :
                Coursedel=j  
        blockedCourses.append(Course[Coursedel])
...
if __name__ == "__main__":
    ...
    filepath = r"D:/ABHIJITH IYER R/jce/notes , textbooks etc/sem 5/open elective allotment project/NewAllotment.xlsx"
    #  "d:/CSE/5TH SEMESTER/Open Elective Allotment/NewAllotment.xlsx" 
